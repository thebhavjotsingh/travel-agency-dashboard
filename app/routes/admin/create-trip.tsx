        ...
        <form className="trip-form" onSubmit={handleSubmit}>
          <div>
            ...
            <ComboBoxComponent
              ...
              itemTemplate={(country: any) => (
                <div className="flex items-center gap-1 px-2">
                  <img
                    src={country.flag}
                    alt={`${country.text} flag`}
                    className="h-6 aspect-7/5 rounded-[0.4rem] object-cover"
                  />
          ...
          <footer className="px-6 w-full">
            <ButtonComponent
              ...
              disabled={loading}>
              <img alt="AI-star" src={`/assets/icons/${loading ? 'loader.svg' : 'magic-star.svg'}`} className={cn("size-5", {'animate-spin' : loading})} />
